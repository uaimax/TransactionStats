...
class StatisticsHelperTest extends TestCase
{
    ...
    public function test_get_statistics()
    {
        ...
        StatisticsHelper::addTransaction(100.50, $timestamp);
        StatisticsHelper::addTransaction(200.75, $timestamp->copysubSeconds(30));
    ...
    public function test_cleanup_old_transactions()
    {
        ...
        // Adicionar logs para verificar o estado após limpeza de transações antigas
        error_log('Estatísticas após limpeza: ' . print_r($statistics, true));
