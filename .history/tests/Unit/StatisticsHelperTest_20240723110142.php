...
class StatisticsHelperTest extends TestCase
{
    ...
    public function test_add_transaction()
    {
        ...
        $this->assertEquals(1, StatisticsHelper::$count);
        $this->assertEquals(100.50, StatisticsHelper::$sum);
        $this->assertEquals(100.50, StatisticsHelper::$min);
        $this->assertEquals(100.50, StatisticsHelper::$max);
    }
