...
class StatisticsHelperTest extends TestCase
{
    ...
    public function test_add_transaction()
    {
        ...
        StatisticsHelper::addTransaction(101.50, $timestamp);
        ...
        $this->assertEquals(101.50, StatisticsHelper::getMax());
    ...
    public function test_cleanup_old_transactions()
    {
        ...
        // Soma, visto que somente uma transação foi aceita (dentro do prazo)
