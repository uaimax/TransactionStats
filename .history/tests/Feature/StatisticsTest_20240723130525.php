...
class StatisticsTest extends TestCase
{
    ...
    public function test_get_statistics_after_cleanup(): void
    {
        ...
        // Adicionando transações válidas via API
        $this->postJson('/api/transactions', ['amount' => 200.00, 'timestamp' => Carbon::now()->subSeconds(10)->format('Y-m-d\TH:i:s.v\Z')]);
        $this->postJson('/api/transactions', ['amount' => 300.00, 'timestamp' => Carbon::now()->subSeconds(30)->format('Y-m-d\TH:i:s.v\Z')]);
