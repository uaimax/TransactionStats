    ...
    public function store(Request $request){
        ...
        try {
            SemaphoreHelper::Semaphore($semaphoreKey, function() use ($data, $timestamp) {
                ...
                $transactions = json_decode(file_get_contents(storage_path('app/transactions.json')), true) ?: [];
                $transactions[] = $data;
                file_put_contents(storage_path('app/transactions.json'), json_encode($transactions));
