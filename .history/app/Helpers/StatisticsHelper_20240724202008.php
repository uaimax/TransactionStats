...
class StatisticsHelper 
{
    ...
    public function getStatistics() {
        ...
        if($this->statistics[$minuteIndex]['count'] == 0){
            ...
            $min = $this->statistics[$minuteIndex]['min']number_format(, 2, '.', '');
        ...
        return [
            ...
            'max' => number_format($this->statistics[$minuteIndex]['min'], 2, '.', ''),
            'min' => number_format($this->statistics[$minuteIndex]['max'], 2, '.', ''),
