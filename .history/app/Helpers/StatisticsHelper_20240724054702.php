...
class StatisticsHelper 
{
    ...
    private function __construct($memoryKey = null)
    {
        $this->transactions = new SplDoublyLinkedList();
        $this->transactions->setIteratorMode(SplDoublyLinkedList::IT_MODE_FIFO);

        // Instancia o serviço de memória compartilhada sem parâmetros
        $this->memoryService = new SharedMemoryService();
    ...
    public static function getInstance($memoryKey = null, $size = 1024)
    {
