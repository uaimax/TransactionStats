...
class StatisticsHelper 
{
    ...
    public function syncDataToFile()
    {
        ...
        // Salvar dados no arquivo usando o Storage do Laravel
        Storage::disk('local')->put('transactions.json', json_encode($data));
    }
    ...
    public function addTransaction($amount, $timestamp)
    {
        ...
        // Log para debugging
        Log::info("Adding transaction with timestamp: $timestamp to minute index: $minuteIndex");
    ...
    public function cleanUpOldTransactions()
    {
        ...
        Log::info("Current minute index calculated: $currentMinuteIndex");
