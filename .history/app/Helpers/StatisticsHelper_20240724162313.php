...
class StatisticsHelper 
{
    ...
    public function cleanUpOldTransactions()
    {
        ...
        if (isset($this->transactions[$oldestIndex])) {
            foreach ($this->transactions[$oldestIndex] as $transaction) {
                $this->sum -= $transaction['amount'];
                $this->count--;
            ...
            // Limpa o índice.
            $this->transactions[$oldestIndex] = [];  // Em vez de unset, apenas redefina como um array vazio
        }
    ...
    private function updateMinMax($amount)
    {
