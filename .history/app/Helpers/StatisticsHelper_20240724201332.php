...
class StatisticsHelper 
{
    ...
    private $statistics = [];
    private $max = PHP_FLOAT_MAX;  // Valor máximo das transações.
    private $min = PHP_FLOAT_MIN;  // Valor mínimo das transações.
    ...
    public function addTransaction($amount, $timestamp)
    {
        ...
        if(!isset($this->statistics[$minuteIndex])){
            $this->statistics[$minuteIndex] = ['sum'=> 0, 'count' => 0, 'max' => 0, 'min' => $this->min];
        }
