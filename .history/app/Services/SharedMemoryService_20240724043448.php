...
class SharedMemoryService
{
    ...
    // Setar o construtor
    public function __construct($key = null, $size = 2048)
    {
    ...
    public function read($offset = 0, $size = null)
    {
        ...
        $result = @unserialize($data); // Use @ para suprimir erros de deserialização
        if ($result === false) {
            Log::error('Erro ao deserializar os dados da memória', ['data' => $data]);
            return [];
        }
        return $result;
    }
